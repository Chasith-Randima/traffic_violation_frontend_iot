...
const Index = ({ data }) => {
  ...
  const handleChecked = async () => {
    let id = router.query.Index;
    let checked = true;
    let token = getCookie("token_user");
    let checkedDate = new Date().toISOString();

    await updateCase(id, { checked: checked, checkedDate: checkedDate }, token)
      .then((data) => {
        console.log(data);
        if (data.status && data.status == "success") {
          setAlert({
  ...
  const handleActive = async () => {
    ...
    await updateCase(id, { active: active }, token)
      .then((data) => {
        console.log(data);
        if (data.status && data.status == "success") {
          setAlert({
  ...
  const handleWarrent = async (checkedDate) => {
    if (new Date(new Date(checkedDate).getDate() + 7) < new Date()) {
      setAlert({
        ...alert,
        loading: false,
        message:
          "There is still time for this person to pay his fine...After only 7 days you can open a warrent..",
        error: false,
        success: true,
      });
      ...
      let warrented = true;
      let token = getCookie("token_user");
      let warrentedDate = new Date().toISOString();
      let data = {
        warrented,
        warrentedDate,
      };

      await updateCase(id, data, token)
        .then((data) => {
          console.log(data);
          if (data.status && data.status == "success") {
            setAlert({
        ...
        <div className="mt-5 mr-5 shadow-xl ">
          ...
          <div className="border-2 border-gray-200 rounded-xl p-2 m-5 mb-5">
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Current Owner: <span>{data.doc.currentOwner}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Vehicle Number : <span>{data.doc.vehicleNumber}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Current Owner City: <span>{data.doc.currentOwnerCity}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Current Owner Address :{" "}
                  <span>{data.doc.currentOwnerAddress}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Case Date: <span>{data.doc.receivedDate.split("T")[0]}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Case Time :{" "}
                  <span>
                    {data.doc.receivedTime.split(":")[0]}:
                    {data.doc.receivedTime.split(":")[1]}
                  </span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Camera Location : <span>{data.doc.cameraLocation}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Registered Date : <span>{data.doc.dateOfRegistration}</span>
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Make : <span>{data.doc.make}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Model : <span>{data.doc.model}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  CR Type : <span>{data.doc.crType}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Status : <span>{data.doc.statusWhenRegisterd}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Year Of Manufacture :{" "}
                  <span>{data.doc.yearOfManufacture}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Body Type : <span>{data.doc.typeOfBody}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Fuel Type : <span>{data.doc.fuelType}</span>
                </h2>
              </div>
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Engine Capacity : <span>{data.doc.engineCapacity}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  ...
                  <span>{data.doc.conditionsAndNotes}</span>
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              <div className="col-span-2 p-2">
                <h2 className="text-lg font-semibold text-gray-600 ">
                  Active :{" "}
                  {data.doc.active ? (
                    <span className="bg-red-500 text-white font-semibold">
                      True
                    </span>
                  ) : (
                    <span className="bg-green-500 text-white font-semibold">
                      False
                    </span>
                  )}
                </h2>
              </div>
              {
                // data.doc.ative &&
                //   data.doc.qued &&
                //   data.doc.warrented == false &&
                data.doc.active && (
                  // data.doc.checked && data.doc.warrented && (
                  <div
                    className="col-span-2 p-2 bg-blue-400 text-white rounded hover:bg-blue-700 transition-all hover:text-white cursor-pointer text-center"
            ...
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              ...
              </div>
              {
                ...
                //   data.doc.warrented == false &&
                // true && true && (
                data.doc.checked && data.doc.warrented == false && (
                  <div
                    className="col-span-2 p-2 bg-blue-400 text-white rounded hover:bg-blue-700 transition-all hover:text-white cursor-pointer text-center"
                    onClick={() => handleWarrent(data.doc.checkedDate)}
                  >
                    <h2 className="text-lg font-semibold ">Warrent Issued</h2>
                  </div>
                )
              }
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-100 rounded-lg my-2 hover:bg-gray-200">
              ...
              </div>
              {
                ...
                //   data.doc.qued &&
                //   data.doc.warrented == false &&
                data.doc.qued && data.doc.checked == false && (
                  <div
                    className="col-span-2 p-2 bg-blue-400 text-white rounded hover:bg-blue-700 transition-all hover:text-white cursor-pointer text-center"
                    onClick={handleChecked}
                  >
                    <h2 className="text-lg font-semibold ">Mark As Checked</h2>
                  </div>
                )
              }
            </div>
...
Index.getInitialProps = async ({ query }) => {
  // console.log(query);
  return await oneCase(query.Index)
    .then((data) => {
      return { data };
    })
    .catch((err) => {
