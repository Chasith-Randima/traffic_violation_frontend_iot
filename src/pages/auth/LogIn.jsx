...
import { getCookie, logIn, isAuth, authenticate } from "actions/auth";
      ...
      <div className="flex flex-row md:flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
        <div className="flex flex-row md:flex-col items-center justify-center md:w-full flex-2 md:px-20 text-center">
          <div className="bg-white rounded-2xl shadow-2xl md:flex md:w-2/3 md:max-w-4xl">
               ...
               */}
                <div className="flex mt-10 flex-col items-center">
                  ...
                  <button
                    ...
                    className=" mt-5 border-2 border-blue-500 text-blue-500 rounded-full px-11 py-1 font-semibold hover:bg-blue-500 hover:text-white"
                  >
                    LogIn
                  </button>
                </div>
            ...
            <div className="md:w-2/5 bg-blue-500 text-white rounded-tr-2xl rounded-br-2xl md:py-36 md:px-16 pb-4 ">
              <img
      ...
      {/* <div class="container py-16">
        <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
          ...
          <p class="mt-4 text-gray-600 text-center">
            ...
            <Link href={`/auth/users/SignUp`} class="text-primary">
              Register Now
            </Link>
          </p>
        </div>
