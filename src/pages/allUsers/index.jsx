    ...
    <>
      <Layout>
        ...
        {show ? (
          ...
          <div className=" mr-10 border-2 border-gray-200 rounded-xl">
            <div className="grid grid-cols-6 md:grid-cols-7 bg-gray-600 p-4 rounded-xl text-white text-xl font-sb ">
              <h2>Id</h2>
              <h2>Name</h2>
              <h2 className="hidden col-span-1 md:block ">Police Id</h2>
