...
const Index = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      if (
        ...
        setAlert({
          message:
            "you dont have the access to this route redirecting to main page",
          loading: true,
        });
        router.push("/");
      }
  ...
  const handleSubmit = async () => {
    ...
    await updateUser(router.query.Index, values.formData, token)
      .then((data) => {
        ...
        <form className="m-10 border-2 border-gray-400 p-10 rounded">
          <div>
            ...
            >
              ...
              <option className="text-gray-600 text-xl">user</option>
