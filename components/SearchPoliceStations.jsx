...
import { searchPoliceStations } from "actions/police";
...
const SearchPoliceStations = () => {
  ...
  const handleSubmit = async () => {
    ...
    await searchPoliceStations({ search: search })
      .then((data) => {
        console.log(data);
        setData(data);
        // console.log(data);
...
export default SearchPoliceStations;
